...
teleport = "Camp Drybone"     --Enter the name of the Teleporter where youu farm Fates so it teleport back to the area and keeps farming
...
fatewait = 3               --the amount how long it should when before dismounting (0 = at the edge of the fate 3-5 = should be in the middle of the fate)
...
TurnIn = true             --should it to Turn ins at the GC
